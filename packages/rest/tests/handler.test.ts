...
describe('rest handler', () => {
  ...
  test('works on [never input]', async () => {
    ...
    expect(response.body).toBe(JSON.stringify(1))
  })
  ...
  test('works on [scalar input on query]', async () => {
    ...
    expect(response.status).toBe(200)
    expect(response.body).toBe(JSON.stringify(123))
  })
  ...
  test('works on [object input on query]', async () => {
    ...
    expect(response.status).toBe(200)
    expect(response.body).toBe(JSON.stringify(2.2))
  })
  ...
  test('works on [object input spread on param]', async () => {
    ...
    expect(response.status).toBe(200)
    expect(response.body).toBe(JSON.stringify('pong'))
  })
  ...
  test('dont works on [object input spread on param]', async () => {
    ...
    expect(response.body).toStrictEqual(JSON.stringify({ notAPing: 'Not a ping!' }))
  })
  ...
  test('works on [output with retrieve]', async () => {
    ...
    expect(response.status).toBe(200)
    expect(response.body).toStrictEqual(JSON.stringify({ username: 'name', live: true }))
    ...
    expect(response2.body).toStrictEqual(
      JSON.stringify({ username: 'name', live: true, friend: { username: 'name2', live: true } }),
    )
  })
  ...
  test('works on [complex object input on query]', async () => {
    ...
    expect(response.status).toBe(200)
    expect(response.body).toStrictEqual(JSON.stringify(6))
  })
})
