...
export const ipv6: Arbitrary<m.IPType> = () =>
  fc.stringMatching(
...
export const ip: Arbitrary<m.IPType> = (options) => fc.oneof(ipv4(options), ipv6(options))

export const mac: Arbitrary<m.IPType> = () =>
  fc
    .tuple(
      fc.integer({ min: 0, max: 255 }).map((v) => v.toString(16).padStart(2, '0')),
      fc.integer({ min: 0, max: 255 }).map((v) => v.toString(16).padStart(2, '0')),
      fc.integer({ min: 0, max: 255 }).map((v) => v.toString(16).padStart(2, '0')),
      fc.integer({ min: 0, max: 255 }).map((v) => v.toString(16).padStart(2, '0')),
      fc.integer({ min: 0, max: 255 }).map((v) => v.toString(16).padStart(2, '0')),
...
export const version: Arbitrary<m.IPType> = () =>
  fc
    .tuple(fc.integer({ min: 0, max: 10000 }), fc.integer({ min: 0, max: 10000 }), fc.integer({ min: 0, max: 10000 }))
    .map(([a, b, c]) => `${a}.${b}.${c}`)
